...
One last step is required so that Cloud9 IDE uses assigned IAM Instance profile. Open the Cloud9 `Preferences`, go to `AWS Settings`, and disable `AWS managed temporary credentials` as depicted in the diagram
