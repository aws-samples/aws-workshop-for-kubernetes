...
https://coredns.io/[CoreDNS] implements the https://github.com/kubernetes/dns/blob/master/docs/specification.md[spec] defined for Kubernetes DNS-Based service discovery. And thus it can run in place of the standard https://github.com/kubernetes/kubernetes/tree/master/cluster/addons/dns[Kube-DNS] that comes default as part of Kubernetes.

This tutorial will show you how to update an existing Kubernetes cluster to use CoreDNS instead of the default Kube-DNS for service discovery.
