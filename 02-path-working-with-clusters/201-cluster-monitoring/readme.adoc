...
Install a Java application as explained in link:../../03-path-application-development/307-app-management-with-helm[Deploying applications using Kubernetes Helm charts].
