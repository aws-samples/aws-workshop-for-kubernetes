...
https://github.com/CloudyMind/kubernetes-aws-workshop/blob/master/deployment-concepts/deployments.adoc
...
https://github.com/CloudyMind/kubernetes-aws-workshop/blob/master/deployment-concepts/replicasets.adoc
...
https://github.com/CloudyMind/kubernetes-aws-workshop/blob/master/deployment-concepts/daemonsets.adoc

== Services
A Kubernetes service defines a logical set of pods and enables them to be access through micro-services. 
https://github.com/CloudyMind/kubernetes-aws-workshop/blob/master/deployment-concepts/services.adoc