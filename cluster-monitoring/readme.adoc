...
The Dashboard uses the https://kubernetes.io/docs/admin/authorization/rbac/[RBAC API], which has been promoted in v1.8 to GA rather than Beta, so you'll use a different version of
