...
Save the changes and exit the editor. Kubernetes cluster needs to re-read the configuration. This can be done by forcing a rolling update of the cluster using the following command:
  ...
  I1024 06:51:08.660179    2156 instancegroups.go:350] Stopping instance "i-0cf49dfd778de8fdd", node "ip-172-20-46-130.ec2.internal", in AWS ASG "master-us-east-1a.masters.cluster.k8s.local".
  I1024 06:56:08.836734    2156 instancegroups.go:350] Stopping instance "i-099c930cb3c1b712a", node "ip-172-20-89-122.ec2.internal", in AWS ASG "master-us-east-1b.masters.cluster.k8s.local".
  I1024 07:01:09.335770    2156 instancegroups.go:350] Stopping instance "i-0b0849b685f3d1dff", node "ip-172-20-127-230.ec2.internal", in AWS ASG "master-us-east-1c.masters.cluster.k8s.local".
  I1024 07:06:09.777166    2156 instancegroups.go:350] Stopping instance "i-02a0bde58819b874f", node "ip-172-20-54-5.ec2.internal", in AWS ASG "nodes.cluster.k8s.local".
...
The output shows three pods corresponding to the three master nodes.
