...
Create a cluster with Route53 private hosted zone and VPC. For this to work you must have created the Route53 private host zone, as explained above[Create hosted zone on Route53]:
