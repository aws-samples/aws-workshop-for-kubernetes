...
. Launch a EC2 (at least 4GB Memory) with Ubuntu image, make sure you have a public IP and can SSH into this instance.
...
Kubernetes dashboard with minikube can be easily viewed using the following command ( Do not run this if your minikube on EC2, instead just point your browser to http://127.0.0.1:30000):
