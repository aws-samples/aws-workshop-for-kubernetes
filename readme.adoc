...
You can share this workshop via https://amzn.to/k8s-on-aws. We encourage participation; if you find anything, please submit an issue. If you want to help raise the bar, submit a PR!
