...
== Configuration data and Secrets using AWS Parameter Store (WORK IN PROGRESS)
...

  {
    ...
    "Statement": [
      ...
      },
      {
        ...
        "Principal": {
          "AWS": [
            "arn:aws:iam::091144949931:user/arun",
            "arn:aws:iam::091144949931:role/nodes.example.cluster.k8s.local"
          ]
        },
        "Action": [
          "kms:Create*",
...
+
  $ aws ssm put-parameter \
    ...
    --value Hello \
    --type SecureString \
    --key-id arn:aws:kms:us-east-1:091144949931:key/414a963b-7fe4-4a61-b19f-ea408b9bda3b
  {
      "Version": 1
  }
+
...
Check the logs of the Pod:
  ...
  Exception in thread "main" com.amazonaws.services.simplesystemsmanagement.model.AWSSimpleSystemsManagementException: User: arn:aws:sts::091144949931:assumed-role/nodes.example.cluster.k8s.local/i-05101c6ca462115a9 is not authorized to perform: ssm:GetParameter on resource: arn:aws:ssm:us-east-1:091144949931:parameter/GREETING (Service: AWSSimpleSystemsManagement; Status Code: 400; Error Code: AccessDeniedException; Request ID: d8a3e20a-d17f-11e7-a11d-5323541cf7d1)
  ...
  at com.amazonaws.services.simplesystemsmanagement.AWSSimpleSystemsManagementClient.doInvoke(AWSSimpleSystemsManagementClient.java:6495)
  at com.amazonaws.services.simplesystemsmanagement.AWSSimpleSystemsManagementClient.invoke(AWSSimpleSystemsManagementClient.java:6471)
  at com.amazonaws.services.simplesystemsmanagement.AWSSimpleSystemsManagementClient.executeGetParameter(AWSSimpleSystemsManagementClient.java:3955)
  at com.amazonaws.services.simplesystemsmanagement.AWSSimpleSystemsManagementClient.getParameter(AWSSimpleSystemsManagementClient.java:3931)
  at org.examples.java.App.getSecret(App.java:25)
  at org.examples.java.App.main(App.java:16)

This should show that the Java application has been able to read the secrets correctly. This is tracked as https://github.com/aws-samples/aws-workshop-for-kubernetes/issues/250.
