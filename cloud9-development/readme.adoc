...
One last step in Cloud9 is required so that the IDE uses assigned IAM Instance profile. Open Cloud9 preferences and go to AWS Settings to disable AWS managed temporary credential as depicted in the diagram
...
Note: you can get the name of S3 bucket in the Outputs tab in your CloudFormation Console
