...
link:../cluster-install#multi-master-multi-node-multi-az-gossip-based-cluster[cluster install] documentation.
...
Review the steps to create a Kubernetes cluster on AWS using Kops in the
link:../cluster-install#default-gossip-based-cluster[cluster install] documentation.
