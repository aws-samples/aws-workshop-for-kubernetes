...
Helm allows you to find issues with your chart's formatting or templates using `lint` command. Let's run `helm lint` on our sample application:
...
```
NAME:   unhinged-crab
LAST DEPLOYED: Tue Oct 17 03:18:31 2017
NAMESPACE: default
STATUS: DEPLOYED
...
db      100.65.195.189  <none>       3306/TCP  1s
webapp  100.71.21.2     <none>       8080/TCP  1s
```
